...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="${pageContext.request.contextPath }/resources/myPage/assets/img/favicon/favicon.ico" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="${pageContext.request.contextPath }/resources/myPage/assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
...
<!--                   <span class="app-brand-text demo text-body fw-bolder">Trade-UP</span> -->
                  <span class="app-brand-text demo text-body fw-bolder">Trade-UP</span>
                </a>
              </div>
              <!-- /Logo -->
